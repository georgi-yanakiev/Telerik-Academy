namespace ParticleSystem
{
    ...
    public class ParticleEmitter : Particle
    {
        ...
        public ParticleEmitter(MatrixCoords position, MatrixCoords speed, Random randGenerator, uint maxEmittedPerTickCount, uint maxAbsSpeedCoord, Func<ParticleEmitter, Particle> randomParticleGeneratorMethod) : base(position, speed)
        {

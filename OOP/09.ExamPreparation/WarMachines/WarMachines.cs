...
namespace WarMachines.Machines
{
    ...
    public class Fighter : Machine, IFighter, IMachine
    {
        ...
        public Fighter(string name, double attackPoints, double defensePoints, bool initialStealthMode) : base(name, attackPoints, defensePoints)
        {
...
namespace WarMachines.Machines
{
    ...
    public class Tank : Machine, ITank, IMachine
    {
        ...
        public bool DefenseMode
        {
            get
            {
                return this.defenseModeState;
            }
            private set
            {
                this.defenseModeState = value;
            }
        }

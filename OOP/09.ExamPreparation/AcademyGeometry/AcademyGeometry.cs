...
namespace GeometryAPI
{
    ...
    public class Cylinder : Figure, IAreaMeasurable, IVolumeMeasurable
    {
        ...
        public double GetArea()
        {
            double topAndBottomArea = GetBaseArea() * 2;
    ...
    public class AdvancedFigureController : FigureController
    {
        ...
        protected override void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            switch (splitCommand[0])
            {
                case "area":
                    {
                        var IsAreaMeasurable = this.currentFigure as IAreaMeasurable;
                        if (IsAreaMeasurable != null)
                        {
                            Console.WriteLine("{0:0.00}", IsAreaMeasurable.GetArea());
                        }
                        else
                        {
                ...
                case "volume":
                    {
                        var IsVolumeMeasurable = this.currentFigure as IVolumeMeasurable;
                        if (IsVolumeMeasurable != null)
                        {
                            Console.WriteLine("{0:0.00}", IsVolumeMeasurable.GetVolume());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
                ...
                case "normal":
                    {
                        var isFlat = this.currentFigure as IFlat;
                        if (isFlat != null)
                        {
                            Console.WriteLine(isFlat.GetNormal().ToString());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
